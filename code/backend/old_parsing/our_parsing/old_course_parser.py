...
course_request = json.loads(
    requests.get(
        API_URL
        + "/"
        + args.school.replace(" ", "%20")
        + "/"
        + args.term.replace(" ", "%20"),
