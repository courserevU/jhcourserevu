...
from course.api.views import CourseList, CommentList, CourseNumberList, ReviewByCommentList, QueryByNameCourseList, QueryByNumberCourseList, QueryByDepartmentCourseList
...
urlpatterns = [
    ...
    re_path('^review/api/(?P<course_id>.+)/(?P<comment_label>.+)/$', ReviewByCommentList.as_view(), name='teaching_style_by_course_api'),
]
